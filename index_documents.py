"""
Script pour indexer tous les PDFs et créer les embeddings
"""
...
# Chercher PDFs
print("\n[2/4] Recherche des PDFs...")
pdf_files = get_pdf_files()
print(f"OK - {len(pdf_files)} PDFs trouvés")

# Indexer
print("\n[3/4] Indexation en cours...")
...
for pdf_idx, pdf_path in enumerate(pdf_files, 1):
    ...
    print(f"   - Embeddings créés ({len(embeddings)} x 384 dims)")
...
# Sauvegarder dans FAISS
print(f"\n[4/4] Sauvegarde dans FAISS...")
